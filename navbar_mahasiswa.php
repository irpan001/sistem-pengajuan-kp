    ...
    <nav class="pcoded-navbar">
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
                <a href="biodata_mahamahasiswa.php" class="b-brand">
                    <div class="b-bg">
                        <i class="feather icon-home"></i>
                    </div>
                    <span class="b-title"><?php echo$_SESSION['namamahasiswa']; ?></span>
                </a>
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item active">
                        <a href="biodata_mahasiswa.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Profil</span></a>
                    </li>
                    
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Praktek Kerja Lapangan</span></a>
                        <ul class="pcoded-submenu">   
                            <li class=""><a href="kp_mahasiswa.php" class="">Data Kuliah Praktek</a></li>
                            <li class=""><a href="laporan_akhir.php" class="">Unggah Laporan Akhir</a></li>
                        </ul>
                    </li>
                    <li data-username="Table bootstrap datatable footable" class="nav-item">
                        <a href="logout.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-power"></i></span><span class="pcoded-mtext">Keluar</span></a>
                    </li>
            </div>
        </div>
    </nav>
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light">
        <div class="m-header">
            ...
            <a href="index.html" class="b-brand">
                   ...
                   <span class="b-title">Praktek Kerja Lapangan</span>
               </a>
        </div>
